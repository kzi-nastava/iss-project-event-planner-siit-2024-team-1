...
-- DJ Service
('Product',11,  'Professional DJ Services',
...
INSERT INTO review (id, reviewers_username, comment, rating, status) VALUES
-- DJ Service Reviews (ID: 1)
(1, 'johnadoe@example.com', 'Amazing DJ! Kept the party going all night long', 5, true),
(2, 'johnadoe@example.com', 'Great music selection and very professional', 5, true),
(3, 'johnadoe@example.com', 'Good service but could improve song transitions', 4, true),
(4, 'johnadoe@example.com', 'Fantastic energy and crowd engagement', 5, true),

-- Photography Service Reviews (ID: 2)
(5, 'johnadoe@example.com', 'Beautiful photos, captured every moment perfectly', 5, true),
(6, 'johnadoe@example.com', 'Professional service but took longer than promised for delivery', 3, true),
(7, 'johnadoe@example.com', 'Excellent attention to detail', 4, true),
(8, 'johnadoe@example.com', 'Worth every penny, amazing quality', 5, true),

-- Catering Service Reviews (ID: 3)
(9, 'johnadoe@example.com', 'Food was delicious and presentation was beautiful', 5, true),
(10, 'johnadoe@example.com', 'Great variety but some dishes were cold', 3, true),
(11, 'johnadoe@example.com', 'Professional staff and excellent service', 4, true),
(12, 'johnadoe@example.com', 'Outstanding quality and presentation', 5, true),

-- Event Planning Service Reviews (ID: 4)
(13,'johnadoe@example.com', 'Made our event completely stress-free', 5, true),
(14, 'a@a.a', 'Excellent coordination and attention to detail', 5, true),
(15, 'johnadoe@example.com', 'Good planning but some communication issues', 4, true),
(16, 'johnadoe@example.com', 'Went above and beyond our expectations', 5, true),

-- Decoration Service Reviews (ID: 5)
(17, 'johnadoe@example.com', 'Beautiful decorations, exactly what we wanted', 5, true),
(18, 'johnadoe@example.com', 'Creative designs but setup was delayed', 3, true),
(19, 'johnadoe@example.com', 'Transformed the venue beautifully', 4, true),
(20, 'johnadoe@example.com', 'High-quality materials and great execution', 5, true);
...
INSERT INTO merchandise_eventtype (eventtype_id, merchandise_id) VALUES
(1, 11),
(2,11),
(1,22),
(3,22),
...
INSERT INTO merchandise_photo (id, photo) VALUES
(11, '/decorations.jpg'),
(22, '/weddingHall.jpg'),
(33,'/funneralCar.jpeg'),
(44,'/dinja.jpg');
